...
<!-- 等待框 start -->
		...
		<a style="color:#fff;text-align: center;margin-top:20px;" class="button_ok" id="submitInfo"  href="javascript:void(0);" onclick="createHtml('/lc/manage/action/createHtmlModule!createAllHtml.action')">马上生成</a>
		</div>
		<br class="clear"/>
	</div>
</body>

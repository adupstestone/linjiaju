...
<!-- 等待框 start -->
		...
		<a style="color:#fff;text-align: center;margin-top:20px;" class="button_ok" id="submitInfo"  href="javascript:void(0);"  onclick="createHtml('/lc/manage/action/createHtmlModule!createPhoneModule.action')">马上生成</a>
			<img src="<%=curUrl%>/app/lc/manage/resources/img/my/htmlmodule/20130621185611.jpg" alt="" />
		</div>
		<br class="clear"/>
	</div>
</body>

...
<html>
	<head>
		...
		<link href="<%=curUrl%>/lc/manage/resources/css/my/register.css" rel="stylesheet" type="text/css" />
		<script type="text/javascript" src="<%=curUrl%>/lc/manage/resources/js/jquery-1.7.2.min.js" ></script>
		<link href="<%=curUrl%>/lc/manage/my-js/register.js" rel="stylesheet" type="text/css" />
	</head>
	<body fit="true">
							...
							<ul>
								...
								<li>
									...
									<div class="left notInput">
										<div id="levelDiv0">
											<span>
												<select style="width:150px;" onchange="groupChange(this, 0)">

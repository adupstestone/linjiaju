...
* Date:2010-12-14 
* Modules: grid.base.js; grid.subgrid.js; 
*/
(function (b) {
	b.jgrid = b.jgrid || {};
	b.extend(b.jgrid, {htmlDecode:function (f) {
		...
		var i = {m:1, d:1, y:1970, h:0, i:0, s:0}, c, e, k;
		if (j && j !== null && j !== undefined) {
			j = b.trim(j);
			j = j.split(/[\\\/:_;.\t\T\s-]/);
			f = f.split(/[\\\/:_;.\t\T\s-]/);
			var n = b.jgrid.formatter.date.monthNames, a = b.jgrid.formatter.date.AmPm, r = function (t, B) {
				if (t === 0) {
					if (B == 12) {
						B = 0;
					}
		...
		return new (function (j, i) {
			...
			this._group = function (l, m) {
				return {field:l.toString(), unique:m, items:[]};
			};
			...
			this._getOrder = function (l, m, q, A, u) {
				...
				aa = A == "float" || A == "number" || A == "currency" || A == "numeric" ? function (L) {
			...
			this.startsWith = function (l, m) {
				...
				if (N) {
					c._append(c._getStr("this." + l) + ".substr(0," + q + ") == " + c._getStr("\"" + c._toStr(m) + "\""));
				} else {
			...
			this.orderBy = function (l, m, q, A) {
				...
				J.push({by:l, dir:m, type:q, datefmt:A});
				return c;
			};
			return c;
		})(f, null);
			...
			if (!this.grid) {
				var c = b.extend(true, {url:"", height:150, page:1, rowNum:20, rowTotal:null, records:0, pager:"", pgbuttons:true, pginput:true, colModel:[], rowList:[], colNames:[], sortorder:"asc", sortname:"", datatype:"xml", mtype:"GET", altRows:false, selarrrow:[], savedRow:[], shrinkToFit:true, xmlReader:{}, jsonReader:{}, subGrid:false, subGridModel:[], reccount:0, lastpage:0, lastsort:0, selrow:null, beforeSelectRow:null, onSelectRow:null, onSortCol:null, ondblClickRow:null, onRightClickRow:null, onPaging:null, onSelectAll:null, loadComplete:null, gridComplete:null, loadError:null, loadBeforeSend:null, afterInsertRow:null, beforeRequest:null, onHeaderClick:null, viewrecords:false, loadonce:false, multiselect:false, multikey:false, editurl:null, search:false, caption:"", hidegrid:true, hiddengrid:false, postData:{}, userData:{}, treeGrid:false, treeGridModel:"nested", treeReader:{}, treeANode:-1, ExpandColumn:null, tree_root_level:0, prmNames:{page:"page", rows:"rows", sort:"sidx", order:"sord", search:"_search", nd:"nd", id:"id", oper:"oper", editoper:"edit", addoper:"add", deloper:"del", subgridid:"id", npage:null, totalrows:"totalrows"}, forceFit:false, gridstate:"visible", cellEdit:false, cellsubmit:"remote", nv:0, loadui:"enable", toolbar:[false, ""], scroll:false, multiboxonly:false, deselectAfterSort:true, scrollrows:false, autowidth:false, scrollOffset:18, cellLayout:5, subGridWidth:20, multiselectWidth:20, gridview:false, rownumWidth:25, rownumbers:false, pagerpos:"center", recordpos:"right", footerrow:false, userDataOnFooter:false, hoverrows:true, altclass:"ui-priority-secondary", viewsortcols:[false, "vertical", true], resizeclass:"", autoencode:false, remapColumns:[], ajaxGridOptions:{}, direction:"ltr", toppager:false, headertitles:false, scrollTimeout:40, data:[], _index:{}, grouping:false, groupingView:{groupField:[], groupOrder:[], groupText:[], groupColumnShow:[], groupSummary:[], showSummaryOnHide:false, sortitems:[], sortnames:[], groupDataSorted:false, summary:[], summaryval:[], plusicon:"ui-icon-circlesmall-plus", minusicon:"ui-icon-circlesmall-minus"}, ignoreCase:false, cmTemplate:{}}, b.jgrid.defaults, f || {}), e = {headers:[], cols:[], footers:[], dragStart:function (d, g, h) {
					...
					if (this.resizing) {
						...
						var h = c.direction === "ltr" ? d.width + g : d.width - g, o;
						if (h > 33) {
							this.curGbox.css({left:this.resizing.sOL + g});
							if (c.forceFit === true) {
					...
					if (this.resizing) {
						var d = this.resizing.idx, g = this.headers[d].newWidth || this.headers[d].width;
						g = parseInt(g, 10);
						this.resizing = false;
					...
					if (d) {
						var g = b("table:first", e.bDiv), h = b("> tbody > tr:gt(0):visible:first", g).outerHeight() || e.prevRowHeight;
						if (h) {
							e.prevRowHeight = h;
							var o = c.rowNum, p = e.scrollTop = e.bDiv.scrollTop, x = Math.round(g.position().top) - p, w = x + g.height();
							h = h * o;
							var C, G, s;
					...
					var g = d.p, h = g.selrow, o = g.selarrrow ? b.makeArray(g.selarrrow) : null, p = d.grid.bDiv.scrollLeft, x = g.gridComplete;
					g.gridComplete = function () {
						g.selrow = null;
						g.selarrrow = [];
						if (g.multiselect && o && o.length > 0) {
							for (var w = 0; w < o.length; w++) {
								o[w] != h && b(d).jqGrid("setSelection", o[w], false);
							}
						}
				...
				if (this.tagName != "TABLE") {
					...
					if (this.p.colNames.length !== this.p.colModel.length) {
						...
						var t = b("<div class='ui-jqgrid-view'></div>"), B, F = b.browser.msie ? true : false, S = b.browser.safari ? true : false;
						a = this;
						...
						b(J).insertBefore(t).attr({id:"gbox_" + this.id, dir:n});
						...
						var N = function (d, g) {
							...
							if (g && a.p.scroll) {
								b(">div:first", d).css({height:"auto"}).children("div:first").css({height:0, display:"none"});
								d.scrollTop = 0;
							}
						}, aa = function () {
							...
							var x = new Date, w = a.p.datatype != "local" && a.p.loadonce || a.p.datatype == "xmlstring", C, G = a.p.datatype == "local" ? "local" : "xml";
							if (w) {
								a.p.data = [];
								a.p._index = {};
							...
							if (b.isXMLDoc(d)) {
								...
								var s, v = 0, y, D, K = 0, H = 0, E = 0, Q, z = [], W, T = {}, O, M, X = [], na = a.p.altRows === true ? " " + a.p.altclass : "";
								...
								G = (Q + "").indexOf("[") === -1 ? z.length ? function (ca, Y) {
								...
								var fa = d.length, Z = 0;
								if (d && fa) {
									var ga = parseInt(a.p.rowNum, 10), qa = a.p.scroll ? (parseInt(a.p.page, 10) - 1) * ga + 1 : 1;
									if (p) {
										ga *= p + 1;
									}
									...
									for (; Z < fa; ) {
										...
										if (a.p.grouping) {
											...
											for (var ya = 0; ya < s; ya++) {
												D.push(T[a.p.groupingView.groupField[ya]]);
											}
							...
							if (d) {
								...
								W = T.length;
								d = 0;
								var na = parseInt(a.p.rowNum, 10), fa = a.p.scroll ? (parseInt(a.p.page, 10) - 1) * na + 1 : 1;
								if (p) {
									na *= p + 1;
								}
								...
								for (; d < W; ) {
									...
									if (a.p.grouping) {
										...
										for (var ha = 0; ha < v; ha++) {
											y.push(O[a.p.groupingView.groupField[ha]]);
										}
									...
									if (a.p.gridview === false) {
										if (a.p.treeGrid === true) {
											...
											b("#" + a.p.id + " tbody:first").append(D.join(""));
										}
										if (a.p.subGrid === true) {
											try {
								...
								if (a.p.gridview === true) {
									a.p.grouping ? b(a).jqGrid("groupingRender", ga, a.p.colModel.length) : b("#" + a.p.id + " tbody:first").append(D.join(""));
								}
								a.p.totaltime = new Date - x;
								if (s > 0) {
									if (a.p.records === 0) {
							...
							if (b.isArray(a.p.data)) {
								...
								b.each(a.p.colModel, function () {
									...
									if (w == "date" || w == "datetime") {
										...
										h[this.name] = {stype:w, srcfmt:x, newfmt:C};
									} else {
										h[this.name] = {stype:w, srcfmt:"", newfmt:""};
									}
								...
								if (a.p.treeGrid) {
									b(a).jqGrid("SortTree", d, a.p.sortorder, h[d].stype, h[d].srcfmt);
								} else {
									var s = {eq:function (z) {
										return z.equals;
									}, ne:function (z) {
									...
									if (a.p.search === true) {
										...
										if (y) {
											...
											for (var K = 0, H = y.rules.length, E; K < H; K++) {
												E = y.rules[K];
												D = y.groupOp;
												if (s[E.op] && E.field && E.data && D) {
													v = D.toUpperCase() == "OR" ? s[E.op](v)(E.field, E.data, h[E.field]).or() : s[E.op](v)(E.field, E.data, h[E.field]);
												}
											}
										} else {
											try {
									...
									if (d && a.p.sortorder && g) {
										a.p.sortorder.toUpperCase() == "DESC" ? v.orderBy(a.p.sortname, "d", h[d].stype, h[d].srcfmt) : v.orderBy(a.p.sortname, "a", h[d].stype, h[d].srcfmt);
									}
									s = v.select();
							...
							if (!a.grid.hDiv.loading) {
								...
								if (a.p.grouping) {
									...
									if (a.p.groupingView.groupDataSorted === true) {
										h[p.sort] = a.p.groupingView.groupField[0] + " " + a.p.groupingView.groupOrder[0] + ", " + h[p.sort];
									}
								}
								...
								if (b.isFunction(a.p.datatype)) {
									...
									switch (o) {
									  ...
									  case "xml":
									  case "script":
										b.ajax(b.extend({url:a.p.url, type:a.p.mtype, dataType:o, data:b.isFunction(a.p.serializeGridData) ? a.p.serializeGridData.call(a, a.p.postData) : a.p.postData, success:function (s) {
						...
						B = function (d, g) {
							var h = "", o = "<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>", p = "", x, w, C, G, s = function (v) {
								var y;
							...
							if (a.p.rowList.length > 0) {
								...
								for (w = 0; w < a.p.rowList.length; w++) {
									p += "<option role=\"option\" value=\"" + a.p.rowList[w] + "\"" + (a.p.rowNum == a.p.rowList[w] ? " selected=\"selected\"" : "") + ">" + a.p.rowList[w] + "</option>";
								}
								p += "</select></td>";
							}
							if (n == "rtl") {
							...
							if (a.p.pginput === true) {
								h = "<td dir='" + n + "'>" + b.jgrid.format(a.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1'></span>") + "</td>";
							}
							...
							if (a.p.pgbuttons === true) {
								...
								b("#first" + g + ", #prev" + g + ", #next" + g + ", #last" + g, "#" + d).click(function () {
									var v = N(a.p.page, 1), y = N(a.p.lastpage, 1), D = false, K = true, H = true, E = true, Q = true;
									if (y === 0 || y === 1) {
										Q = E = H = K = false;
									} else {
										if (y > 1 && v >= 1) {
							...
							a.p.pginput === true && b("input.ui-pg-input", "#" + x).keypress(function (v) {
								if ((v.charCode ? v.charCode : v.keyCode ? v.keyCode : 0) == 13) {
									//a.p.page = b(this).val() > 0 ? b(this).val() : a.p.page;//若输入的页数大于总页数，有问题，所以屏蔽这段，新增下面的判断
									if(b(this).val() > a.p.lastpage)
								    	a.p.page = a.p.lastpage;
								    else if (b(this).val() < 0)
								    	a.p.page = 0;
								    else
								    	a.p.page = b(this).val();
						...
						var Ca = function (d, g, h, o) {
								...
								if (!(a.p.savedRow.length > 0)) {
									if (!h) {
										if (a.p.lastsort == g) {
											...
											a.p.sortorder = a.p.colModel[g].firstsortorder || "asc";
										}
										a.p.page = 1;
									}
									if (o) {
										if (a.p.lastsort == g && a.p.sortorder == o && !h) {
											return;
										} else {
											a.p.sortorder = o;
										}
							...
							if (b(a.grid.cDiv).is(":visible")) {
								h[1] += b(a.grid.cDiv).height() + parseInt(b(a.grid.cDiv).css("padding-top"), 10) + parseInt(b(a.grid.cDiv).css("padding-bottom"), 10);
							}
							if (a.p.toolbar[0] === true && (a.p.toolbar[1] == "top" || a.p.toolbar[1] == "both")) {
								h[1] += b(a.grid.uDiv).height() + parseInt(b(a.grid.uDiv).css("border-top-width"), 10) + parseInt(b(a.grid.uDiv).css("border-bottom-width"), 10);
							}
							if (a.p.toppager) {
								h[1] += b(a.grid.topDiv).height() + parseInt(b(a.grid.topDiv).css("border-bottom-width"), 10);
							}
						...
						for (k = 0; k < a.p.colModel.length; k++) {
							...
							if (a.p.keyIndex === false && a.p.colModel[k].key === true) {
								a.p.keyIndex = k;
							}
						}
						...
						if (this.p.multiselect) {
							...
							this.p.colModel.unshift({name:"cb", width:S ? a.p.multiselectWidth + a.p.cellLayout : a.p.multiselectWidth, sortable:false, resizable:false, hidedlg:true, search:false, align:"center", fixed:true});
						}
						...
						(function () {
							...
							if (a.p.shrinkToFit === true && h > 0) {
								...
								if (w) {
									...
									if (!w && Math.abs(e.width - s - (d + g * h)) !== 1) {
										y = e.width - s - (d + g * h);
									}
								}
						...
						var va = "";
						if (a.p.footerrow) {
							va += "<table role='grid' style='width:" + a.p.tblwidth + "px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-" + n + "'>";
						}
						t = b("tr:first", r);
						...
						if (a.p.pager) {
							...
							b(a.p.pager).css({width:e.width + "px"}).appendTo(J).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom");
							ba && b(a.p.pager).hide();
							B(a.p.pager, "");
						}
						...
						b(a).before(e.hDiv).click(function (d) {
							...
							if (V.tagName == "A" || (V.tagName == "INPUT" || V.tagName == "TEXTAREA" || V.tagName == "OPTION" || V.tagName == "SELECT") && !g) {
								return this;
							}
							if (h === true) {
						...
						b(e.bDiv).append(b("<div style=\"position:relative;" + (F && b.browser.version < 8 ? "height:0.01%;" : "") + "\"></div>").append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height:a.p.height + (isNaN(a.p.height) ? "" : "px"), width:e.width + "px"}).scroll(e.scrollGrid);
						...
						if (a.p.toolbar[0]) {
							...
							if (a.p.toolbar[1] == "both") {
								...
								b(e.uDiv).width(e.width).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id);
							}
							ba && b(e.uDiv).hide();
						}
						if (a.p.toppager) {
						...
						if (a.p.caption) {
							...
							if (a.p.hidegrid === true) {
								b(".ui-jqgrid-titlebar-close", e.cDiv).click(function (d) {
									var g = b.isFunction(a.p.onHeaderClick), h = ".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv", o, p = this;
									...
									if (a.p.gridstate == "visible") {
										b(h, "#gbox_" + a.p.id).slideUp("fast", function () {
											o--;
											if (o == 0) {
												...
												if (g) {
													ba || a.p.onHeaderClick.call(a, a.p.gridstate, d);
												}
											}
										});
									} else {
										a.p.gridstate == "hidden" && b(h, "#gbox_" + a.p.id).slideDown("fast", function () {
											o--;
											if (o == 0) {
						...
						a.updatepager = function (d, g) {
							...
							if (a.p.scroll) {
								...
								if (o = h.outerHeight() || a.grid.prevRowHeight) {
									...
									b(">div:first", a.grid.bDiv).css({height:o}).children("div:first").css({height:h, display:h ? "" : "none"});
								}
								...
								if (a.p.viewrecords) {
									if (a.p.reccount === 0) {
										...
										if (b.fmatter) {
											...
											C = b.fmatter.util.NumberFormat(C, G);
										}
						...
						b.extend(e, {populate:ia, emptyRows:P});
						this.grid = e;
	...
	b.jgrid.extend({getGridParam:function (f) {
				...
				if (b(r).hasClass("jqgrow")) {
					b("td", r).each(function (t) {
						...
						if (a !== "cb" && a !== "subgrid" && a !== "rn") {
							if (n.p.treeGrid === true && a == n.p.ExpandColumn) {
								j[a] = b.jgrid.htmlDecode(b("span:first", this).html());
							} else {
								try {
									j[a] = b.unformat(this, {rowId:r.id, colModel:n.p.colModel[t]}, t);
								}
								catch (B) {
			...
			if (j) {
				try {
					...
					if (n.p.datatype == "local") {
						var F = n.p._index[f];
						if (typeof F != "undefined") {
							n.p.data[F] = b.extend(true, n.p.data[F], B);
						}
						B = null;
					}
				}
		...
		if (j) {
			...
			this.each(function () {
				...
				m = u.p.altclass;
				for (var U = 0, $ = "", P = {}, aa = b.isFunction(u.p.afterInsertRow) ? true : false; U < I; ) {
					q = j[U];
					n = "";
					if (N) {
						try {
						...
						switch (i) {
						  ...
						  case "after":
							if (B = u.rows.namedItem(c)) {
								b(u.rows[B.rowIndex + 1]).hasClass("ui-subgrid") ? b(u.rows[B.rowIndex + 1]).after(n) : b(B).after(n);
							}
							break;
						  case "before":
							if (B = u.rows.namedItem(c)) {
		...
		this.each(function () {
			...
			b(this.p.colModel).each(function (B) {
				...
				if (f == "set") {
					...
					if (f == "get") {
						n[e] = b("tr.footrow td:eq(" + B + ")", r.grid.sDiv).html();
					}
				}
			});
		});
				...
				if (!isNaN(f)) {
					...
					if (j === true) {
						...
						if (a !== 0) {
							...
							B = f - k * a - F;
							if (!isNaN(i.p.height)) {
								if (b(i.grid.bDiv)[0].clientHeight < b(i.grid.bDiv)[0].scrollHeight || i.rows.length === 1) {
									r = true;
									B -= t;
								}
							}
		...
		return this.each(function () {
			var j = this;
			if (j.grid) {
				b(j.grid.bDiv).css({height:f + (isNaN(f) ? "" : "px")});
				j.p.height = f;
		...
		return this.each(function () {
			...
			if (e.grid) {
				...
				if (k >= 0) {
					...
					if (i) {
						typeof i === "string" ? b(n).addClass(i) : b(n).css(i);
					}
				...
				if (a >= 0) {
					if (r = n.rows.namedItem(f)) {
						...
						if (i !== "" || k === true) {
							...
							t = n.p.colModel[a].title ? {title:b.jgrid.stripHtml(r)} : {};
		...
		this.each(function () {
			...
			if (c.grid) {
				...
				if (e >= 0) {
					...
					if (k) {
						try {
							i = b.unformat(b("td:eq(" + e + ")", k), {rowId:k.id, colModel:c.p.colModel[e]}, e);
						}
						catch (n) {
					...
					if (r && r > 0) {
						for (; t < r; ) {
							if (b(n.rows[t]).hasClass("jqgrow")) {
								try {
									e = b.unformat(b(n.rows[t].cells[a]), {rowId:n.rows[t].id, colModel:n.p.colModel[a]}, a);
								}
								catch (B) {
...
(function (b) {
	b.jgrid.extend({setSubGrid:function () {
		return this.each(function () {
			...
			e.p.colModel.unshift({name:"subgrid", width:b.browser.safari ? e.p.subGridWidth + e.p.cellLayout : e.p.subGridWidth, sortable:false, resizable:false, hidedlg:true, search:false, fixed:true});
			e = e.p.subGridModel;
			if (e[0]) {
				...
				var n = function (g, j, f) {
						...
						for (h = 0; h < a.p.subGridModel[0].params.length; h++) {
							for (d = 0; d < a.p.colModel.length; d++) {
								if (a.p.colModel[d].name == a.p.subGridModel[0].params[h]) {
									f[a.p.colModel[d].name] = b("td:eq(" + d + ")", g).text().replace(/\&#160\;/ig, "");
								}
							}
						}
					}
					if (!a.grid.hDiv.loading) {
						...
						switch (a.p.subgridtype) {
						  case "xml":
						  case "json":
							b.ajax(b.extend({type:a.p.mtype, url:a.p.subGridUrl, dataType:a.p.subgridtype, data:b.isFunction(a.p.serializeSubGridData) ? a.p.serializeSubGridData.call(a, f) : f, complete:function (i) {
				...
				b("td:eq(" + c + ")", e).click(function () {
					if (b(this).hasClass("sgcollapsed")) {
						...
						if (b.isFunction(a.p.subGridBeforeExpand)) {
							p = a.p.subGridBeforeExpand.call(a, s + "_" + m, m);
						}
						if (p === false) {
							return false;
						}

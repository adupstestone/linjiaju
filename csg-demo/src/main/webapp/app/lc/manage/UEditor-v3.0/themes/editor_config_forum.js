...
//   URL = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");
    URL = curUrl +"/b2b/manage/UEditor-v3.0/";
	//upURL 图片存放地址
	var upURL = curUrl +"/" ;
/*  * 			//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
*/
    //  URL = "http://localhost:8080/test201303/b2b/manage/";
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:	upURL								//图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
      ...
      /*          'bold', 'italic', 'underline', 'strikethrough', 'superscript', 
                ...
                'imagecenter', '|','gmap','highlightcode','pagebreak',
                '|', 'horizontal', 'date', 'time', 'spechars',
                'snapscreen','|', 'inserttable', 'deletetable', 
        ...
        ,toolbars:[
            [ 'forecolor','insertimage','link','emotion' ]
        ]

...
String filePath = "app/lc/manage/upload/"+savePath;
String realPath = application.getRealPath("/");
if(realPath.endsWith(File.separator) == false){
...
if(ServletFileUpload.isMultipartContent(request)){
	...
	response.getWriter().print("{'original':'"+originalName+"','url':'"+filePath+"/"+url.substring(url.lastIndexOf("/")+1,url.length())+"','title':'"+title+"','state':'"+state+"'}");

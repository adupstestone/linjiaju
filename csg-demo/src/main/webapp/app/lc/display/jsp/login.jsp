...
<script type="text/javascript" src="<%=curUrl%>/lc/manage/resources/js/jquery-easyui/js/jquery-1.7.2.min.js" language="javascript"></script>
<script type="text/javascript">
function loadData(){
 	if(self!=top   &&   parent.document.body.tagName   ==   "FRAMESET")     //普通框架  
 	 { 
 		 top.location= curUrl + '/b2b/manage/jsp/login.jsp';
  	}  
				...
				<div class="form_div">
					<form action="" method="post" id="login_form">
						...
						<div class="button_bottom">
							...
							<div class="right">
								<a href="<%=curUrl %>/b2b/manage/jsp/register.jsp" id="register_btn">注 册</a>
							</div>
							<br class="clear"/>
						</div>

...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" href="<%=curUrl%>/lc/display/resources/css/my/pro-detail.css" type="text/css" media="all" />
		
		<script src="<%=curUrl%>/lc/display/resources/js/jquery-1.7.2.min.js" type="text/javascript"></script>
		<script src="<%=curUrl%>/lc/display/my-js/pro-detail-phone.js" type="text/javascript"></script>
	...
	<body>
	    ...
	    <div class="content_width phone_detail_out_div">
	        <div id="product-intro">
	            ...
	            <div>
					...
					<ul id="choose">
						...
						<li id="choose-result">
							...
							<div class="dd">
								<div class="wrap-input">
									<strong>“白色”</strong>，<strong>“XXX”</strong>
								</div>
							</div>
						</li>
						 -->
		                <li id="choose-btns">
		                    <div id="choose-btn-append">
		                        ...
		                        <a href="<%=curUrl%>/lc/display/jsp/pro-cart.jsp" id="addToCart" class="btn-append left button_pink hide">加入购物车</a>
		                        <a href="<%=curUrl%>/lc/display/jsp/pro-buy-contract.jsp" id="buy_now" class="btn-append left button_pink">立即购买</a>
		                        <span class="clear"></span>
		                    </div>
		                    <!-- 
		                    <div id="choose-btn-dobuy" class="btn">
		                    	<a href="###" class="dobuy">是多少就看到</a>
		                    </div>
		                     -->
		                </li>
	                </ul>
	            ...
	            <div id="preview">
	                <div id="spec-n1" class="jqzoom" onclick="">                    
						<img width='350' height='350' src='<%=curUrl%>/lc/display/resources/img/my/pro-detail/mb/a.jpg'/>
	                </div>
	                <!-- 
	                ...
	                <div id="spec-list">
	                    ...
	                    <div class="spec-items">
	                        <ul class="lh" id='good_img_list'>
	                            <li>
   									<img src='<%=curUrl%>/lc/display/resources/img/my/pro-detail/mb/a.jpg' width='50' height='50' class="img-hover"/>
								</li>
								<li>
   									<img src='<%=curUrl%>/lc/display/resources/img/my/pro-detail/mb/a.jpg' width='50' height='50'/>
								</li>
								<li>
   									<img src='<%=curUrl%>/lc/display/resources/img/my/pro-detail/mb/b.jpg' width='50' height='50'/>
								</li>
								<li>
   									<img src='<%=curUrl%>/lc/display/resources/img/my/pro-detail/mb/c.jpg' width='50' height='50'/>
								</li>
								<li>
   									<img src='<%=curUrl%>/lc/display/resources/img/my/pro-detail/mb/d.jpg' width='50' height='50'/>
								</li>
								<li>
   									<img src='<%=curUrl%>/lc/display/resources/img/my/pro-detail/mb/e.jpg' width='50' height='50'/>
								</li>
								<li>
   									<img src='<%=curUrl%>/lc/display/resources/img/my/pro-detail/mb/f.jpg' width='50' height='50'/>
								</li>
	                        </ul>
	                    </div>
	                </div>
	    	...
	    	<div class="fitting_list">
	    		...
	    		<div class="content">
		    		...
		    		<div class="right buy_buttons">
						<a href="<%=curUrl%>/lc/display/jsp/pro-buy-contract.jsp" id="buy_together" class="btn-append button_pink">一起购买</a>
		    		</div>
		    		<br class="clear"/>
	    		</div>
	    	</div>
	            ...
	            <div id="product-detail" class="m m1" data-widget="tabs">
	                ...
	                <div class="mc" data-widget="tab-content" id="product-detail-1">
						<div id="item-detail-1-1" class="item-detail">
							<div class="content">
								<img src="<%=curUrl%>/lc/display/resources/img/my/pro-detail/detail2.png" alt=""/>
							</div>
						</div>
	                </div>
	                ...
	                <div class="mc hide" data-widget="tab-content" id="product-detail-2">
						<div id="item-detail-2-1" class="item-detail">
							<div class="content">
								<img src="<%=curUrl%>/lc/display/resources/img/my/pro-detail/detail1.png" alt="" style="margin-left: -3px;"/>
							</div>
						</div>
	                </div>
	                ...
	                <div class="mc hide" data-widget="tab-content" id="product-detail-3">
						<div id="item-detail-3-1" class="item-detail">
							<div class="content">
								<img src="<%=curUrl%>/lc/display/resources/img/my/pro-detail/buy_rec.png" alt=""/>
							</div>
	    ...
	    <script type="text/javascript" src="<%=curUrl%>/lc/display/resources/js/detail-zo0m.js?t=20120717.js"></script>

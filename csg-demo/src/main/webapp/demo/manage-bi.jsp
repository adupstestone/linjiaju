...
<%@include file="url.jsp" %>
	<head>
		...
		<link rel="stylesheet" href="<%=curUrl%>/demo/css/manage-bi.css" type="text/css" media="screen" />
		...
		<script src="<%=curUrl%>/demo/js/charts.js" type="text/javascript"></script>
		<script src="<%=curUrl%>/demo/js/chart-cfg.js" type="text/javascript"></script>
